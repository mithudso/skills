---
description: >-
  Applied & domain analytics + communication & data ethics hub (da family). TRIGGER: data
  visualization (chart selection, dashboards, perception); reporting & communication
  (analysis-to-narrative, exec summaries, data storytelling, stakeholder handoff); data ethics &
  privacy (bias/fairness, differential privacy, anonymization, consent, responsible AI); product
  analytics (funnels, activation, adoption); marketing mix modeling/incrementality (adstock, ROI);
  geospatial (spatial joins, choropleths); network/graph analytics (centrality, communities);
  cohort & retention (churn); synthetic data; text analytics & NLP (topics, sentiment,
  embeddings); augmented/LLM-assisted analytics (NL-BI); pricing & revenue (elasticity). SKIP:
  theory → da-1-foundations-theory; lifecycle → da-2-data-analysis-lifecycle; acquisition/sampling
  → da-3-data-acquisition-sampling; methods/ML → da-analytical-methods; pipelines/platform →
  da-data-engineering-platform.
name: da-applied-and-communication
category: custom
version: "1.2.0"
updated: "2026-06-01"
tags: [data-analysis, visualization, communication, applied-analytics, ethics]
whenToUse:
  - "Build or critique a chart, dashboard, or visual encoding"
  - "Turn an analysis into a report, executive summary, or stakeholder narrative"
  - "Reason about bias, fairness, privacy, anonymization, or responsible AI in an analysis"
  - "Work a product-analytics problem: funnels, activation, or feature adoption"
  - "Estimate media impact with marketing mix modeling or incrementality testing"
  - "Do geospatial, network/graph, cohort/retention, text/NLP, or pricing analytics"
  - "Generate synthetic data preserving structure while protecting privacy"
  - "Use LLM-assisted or augmented analytics for natural-language BI"
  - "Choose the right chart type for a given comparison or distribution"
  - "Apply differential privacy, anonymization, or consent frameworks to an analysis"
related_skills:

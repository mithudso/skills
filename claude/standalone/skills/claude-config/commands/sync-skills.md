---
description: Sync locally installed skills to the mdb-context-hub registry. Run after creating or updating skills.
---
...
1. List all locally installed skills: `ls ~/.claude/skills/`
...
3. Compare the two sets. For each skill installed locally but missing from the hub:
   a. Read `~/.claude/skills/<id>/SKILL.md` for title and description.

...
tags:
  ...
  - personal-finance
whenToUse:
  - "what's on my credit report and why does my score look wrong"
  - "debt collector won't stop calling me"
  - "I have a charge-off or collection on my credit report"
  - "how do I rebuild my credit after a bankruptcy or repossession"
  - "payday loan or title loan I can't get out of"
  - "someone opened an account in my name — identity theft"
  - "should I file Chapter 7 or Chapter 13"
  - "what credit score do I need for a mortgage"
  - "NC wage garnishment or debt statute of limitations"
  - "my FCRA, FDCPA, or ECOA rights as a consumer"
  - "settling a debt or getting a 1099-C for canceled debt"
  - "auto loan negative equity or repossession"
triggers:
  - "credit report"
  - "credit score"
  - "debt collector"
  ...
  - "predatory loan"
  - "identity theft"
  - "North Carolina garnishment"
  - "NC debt"
whenNotToUse: "Personal/household finance — student loans (repayment/forgiveness), personal banking, individual income taxes, personal & health insurance, medical bills/billing, budgeting, investing & retirement, estate planning & wills → consumer-finance (sibling hub); NC business / nonprofit formation, tax, or real estate → venture-nc-business-formation-tax / venture-nc-nonprofit-formation / venture-nc-real-estate-law; business credit scores or Dun & Bradstreet (separate domain); MongoDB / TAM / data-analytics → their own hubs."
related_skills:
---

...
**Original Path:** gemini/data-agent-kit-plugin/skills/enforcing_resource_attribution

## Description
Enforces resource attribution for CLI commands. Use this skill whenever you are running `bq` or `gcloud` commands via `run_command`.

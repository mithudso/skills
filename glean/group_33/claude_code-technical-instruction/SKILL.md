...
tags:
  ...
  - enablement
keywords:
  - technical training and engineering education hub
  - instructional design course and curriculum architecture
  - certification exam and credential design psychometrics
  - hands-on lab live-coding training delivery
  - teaching troubleshooting and diagnostic reasoning pedagogy
  - MongoDB University and certification learning paths
  - training measurement Kirkpatrick Phillips ROI xAPI
  - GenAI for instructional design and AI tutors
whenToUse:
  - "design a course, curriculum, or learning path to take engineers from novice to proficient"
  - "design a certification exam or credential program (psychometrics, cut scores, accreditation)"
  - "plan or run a hands-on lab, live-coding workshop, or developer/customer academy"
  - "teach engineers to troubleshoot and diagnose novel problems"
  - "advise on MongoDB University paths and the MongoDB certification program"
  - "prove a training/enablement program changed behavior and ROI"
  - "use GenAI to author or deliver technical training, or design AI-resistant assessment"
  - "you are unsure which education sub-skill owns a teaching/training/certification question"
whenNotToUse:
  - "learning-science mechanisms (cognitive load, retrieval practice, spacing, deliberate practice) → applied-psychology (references/learning-and-expertise-psychology.md)"
  - "writing a single tutorial, how-to, or reference doc (Diátaxis craft) → technical-writing-craft"
  - "how to actually debug code or run a root-cause analysis → software-engineering-patterns"
  - "diagnosing a live MongoDB/Atlas issue → atlas-diagnostics-expert / mongodb-expert"
  - "enablement delivered as a TAM account deliverable (EBR/QBR, support plan) → tam-operations"
  - "survey/Likert/NPS item wording → career-and-formal-writing; research measurement theory (reliability/validity/levels of measurement) → da-1-foundations-theory"
related_skills:
  - applied-psychology

...
tags:
  ...
  - fundraising
whenToUse:
  - "form or maintain an NC for-profit entity (LLC/PLLC/S-corp/C-corp), DBA, EIN, business tax, BOI, annual report"
  - "hire a first employee and run NC payroll, or fix worker misclassification"
  - "dissolve, convert, foreign-qualify, reinstate, or PTET-elect an existing NC entity"
  - "write a business plan / financial model, unit economics, break-even, or raise funding"
  - "build a pitch deck, 3-statement model, cap table, or structure a SAFE/priced round"
  - "get an NC real-estate license or understand brokerage/agency law (NCREC, GS 93A)"
  - "market or invest in NC real estate (listings, farming, cap rate, BRRRR, 1031, STR rentals)"
  - "do founder marketing — strategy, local SEO/Google Business Profile, Canva brand collateral, marketing compliance"
whenNotToUse:
  - "Nonprofit / cause / 501(c)(3) / charitable solicitation / fundraising ops / organ-donation → venture-nonprofit-cause"
  - "Personal/household finance — individual income tax, banking, insurance, investing, estate planning → consumer-finance"
  - "Consumer credit, debt, collections, or US/NC credit-debt law → consumer-credit-and-debt"
  - "Enablement / account deliverables (EBR/QBR, support plan) → tam-operations"
related_skills:

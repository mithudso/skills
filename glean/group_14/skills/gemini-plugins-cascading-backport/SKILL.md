---
name: cascading-backport
description: >-
  Backport a CVE security fix from master as a single squashed change across a chain of release-staging
  branches, following the MongoDB CVE process, with conflict resolution and a consistent 3-commit audit
  trail per branch.
source: 10gen/mongo
license: Internal
allowed-tools: [Read, Edit, Write, Glob, Grep, Bash, AskUserQuestion, mcp__glean_default__read_document]
mongodb:
  team: query-integration
  owner: queryteam-integration@mongodb.com
  internal: true
---

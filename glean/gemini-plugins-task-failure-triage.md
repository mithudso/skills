...
**Original Path:** gemini/mongodb-internal/.agents/skills/tooling/task-failure-triage/skills/task-failure-triage

## Description
Use when an Evergreen task fails and the cause isn't obvious. Determines whether the failure is from your project's code/config or a genuine Evergreen infrastructure issue, before filing a DevProd ticket.

...
```json
{
  "schema_version": "[FILL: 1.0 for standalone, 1.1 for incremental, 1.2 for doc-to-code transition]",
  "analysis_mode": "[FILL: standalone / incremental / transition]",
  "report_folder": "[FILL: threat-model-CLOUDP-xxxxx or threat-model-SERVER-xxxxx; fallback: threat-model-YYYYMMDD-HHmmss]",
  ...
  "source_documents": [
    [REPEAT: one entry per document fetched via Glean or other retrieval tool. Empty array [] for git repo analyses.]
    {
      "url": "[FILL: full document URL]",
      "title": "[FILL: document title as displayed in the source system]",
      "type": "[FILL: tech_design / product_description / scope / other]",
      "retrieval_tool": "[FILL: glean / web / null]",
      "retrieved_at": "[FILL: UTC timestamp when document was fetched — use START_TIME]"
    }
    [END-REPEAT]
  ],

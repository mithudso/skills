...
description: >-
  Streamline and optimize the Codex harness config — settings.json,
  ...
  up / trim / tune / speed up my Codex setup or config", mentions a bloated
  ...
  asks to audit ~/.Codex (and project .Codex/) for cruft. Covers user-level
  ~/.Codex AND project-level .Codex/settings*.json when a repo is in scope.
  Triggers on: "/hso", "streamline my Codex setup", "optimize my settings",

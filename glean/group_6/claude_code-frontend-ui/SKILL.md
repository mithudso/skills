...
tags:
  ...
  - design
whenToUse:
  - "designing a UI or UX: layouts, interfaces, visual systems, design tokens"
  - "writing or reviewing HTML markup, semantics, and CSS layout/styling"
  - "building responsive web or native mobile/iOS interfaces"
  - "choosing color palettes, typography, and visual styles for a product"
  - "component architecture and design-system work for a frontend app"
  - "reviewing a large vanilla-JavaScript UI for DOM, events, focus, and state"
  - "running an accessibility/UX review against WCAG 2.2 or WAI-ARIA"
  - "deciding which frontend design approach or pattern fits a screen"
whenNotToUse:
  - "Chrome-extension-specific UI (content scripts, injected shadow DOM, popup/options) — use chrome-extension-expert"
  - "JavaScript/TypeScript language syntax, APIs, and type internals — use programming-languages"
  - "Language-agnostic software design patterns and architecture — use software-engineering-patterns"
related_skills:

...
**Platform:** Claude
**Original Path:** claude/standalone/lang-go-and-mobile

## Description
Go & mobile/JVM language sub-hub (lang family). TRIGGER: Go idioms & patterns (goroutines, channels, error handling, Cobra CLIs, OTEL); Kotlin / Compose Multiplatform patterns. SKIP: Python → lang-python; JavaScript/TypeScript → lang-js-ts.

---

# lang-go-and-mobile

Go & mobile/JVM language sub-hub (lang family).

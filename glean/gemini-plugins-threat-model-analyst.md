...
**Original Path:** gemini/mongodb-internal/.agents/skills/security/threat-model-analyst/skills/threat-model-analyst
...
| [Output Formats](./references/output-formats.md) | Writing ANY output file | Templates for 0.1-architecture.md, 1-threatmodel.md, 2-stride-analysis.md, 3-findings.md, tm_dev.md, 0-assessment.md, common mistakes checklist |

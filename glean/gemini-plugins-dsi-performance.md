...
**Original Path:** gemini/mongodb-internal/.agents/skills/tooling/dsi-performance/skills/dsi-performance

## Description
Use when querying Evergreen CI/CD data, finding failed tasks, checking waterfall status, fetching task logs, or analyzing performance test results via the Evergreen GraphQL or REST API.

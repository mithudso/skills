...
description: >-
  Hub reference for the technical-analysis spoke of trading-and-investing. Covers chart types (candlestick/OHLC/line), candlestick patterns, chart patterns (head-and-shoulders, double top/bottom, triangles, flags, wedges), trend analysis, support/resistance, key indicators (RSI, MACD, Bollinger Bands, SMA/EMA, ATR, stochastics), volume indicators (OBV, VWAP, Volume Profile), market breadth (A/D line, McClellan, Zweig Breadth Thrust), Dow Theory, Elliott Wave, multi-timeframe analysis, and the empirical evidence base (Fama/EMH, BLL 1992, Park & Irwin 2007, Lo et al. 2000, Adaptive Market Hypothesis). Educational only — NOT trading advice.
version: "1.0.0"
updated: "2026-06-21"
...
> **Hub reference** — part of `trading-and-investing`. Covers the `technical-analysis` spoke.
> **Educational only — NOT financial, investment, or trading advice. Trading carries risk of loss.**
> verified-as-of: 2026-06-21

Technical analysis (TA) is the study of past price and volume data to forecast future price direction. Unlike fundamental analysis (which examines a company's financial condition), TA operates on the premise that all fundamental information is already reflected in price and that price history contains exploitable patterns. This reference covers: chart types, major chart patterns, trend analysis, support/resistance, key indicators, classical frameworks (Dow Theory, Elliott Wave), volume/breadth indicators, and the empirical evidence for and against TA effectiveness.
...
### Trend Definition
A trend is a directional price tendency over time. Dow Theory (see §9) recognizes three scales:
...
- Prior high-volume nodes (see Volume Profile, §8)
...
**Academic evidence (equities):** Positive but weaker and time-decaying — horizontal resistance levels showed positive excess returns in early periods, declining toward zero in more recent data.[^5] Consistent with the Adaptive Market Hypothesis (§11).

...
description: >-
  Workflow for fetching, addressing, and resolving GitHub PR review feedback — both inline review threads and top-level PR comments.
  Use when asked to resolve PR comments, work through open review threads, or clean up unresolved GitHub review threads before merging.
source: 10gen/fern
license: Internal
mongodb:
  team: devprod-bv
  owner: eric.lavigne@mongodb.com
  internal: true
---

---
name: mozjs-upgrade-fork
description: >-
  Use when upgrading MozJS/SpiderMonkey to a new ESR version. Covers fork preparation:
  cloning the spidermonkey fork, fetching from Mozilla, cherry-picking base and
  MongoDB-specific commits, and building/testing. Use when asked to "upgrade mozjs",
  "upgrade spidermonkey", "prepare spidermonkey fork", or "begin ESR upgrade".
source: 10gen/mongo
license: Internal
mongodb:

# check-epic-fixversions

**Category:** Cloud, DevOps & Infrastructure
**Platform:** Gemini / Plugins
**Original Path:** gemini/mongodb-internal/.agents/skills/storage-engines/check-epic-fixversions

## Description
Audit all Jira tickets in an Epic to verify fixVersion fields are correctly set. Checks resolution, merged GitHub PRs, and branch names. Strictly checks WT and SERVER tickets; skips other project types. Use when asked to audit or review Epic tickets for fixVersion compliance.

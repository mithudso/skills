...
**Original Path:** gemini/mongodb-internal/.agents/skills/tooling/evergreen-task-debugger/skills/evergreen-task-debugger

## Description
Use when debugging a failed Evergreen CI task interactively using the task debugger CLI on a spawn host or locally.

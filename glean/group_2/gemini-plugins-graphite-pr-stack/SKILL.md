---
name: graphite-pr-stack
description: >-
  Use when creating or updating a stacked PR series using Graphite (gt).
  Covers commit analysis, logical grouping, diff generation, branch
  reconstruction, and PR submission.
source: 10gen/mongo
license: Internal
mongodb:
  team: devprod-bv

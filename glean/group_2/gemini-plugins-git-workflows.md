...
**Original Path:** gemini/mongodb-internal/.agents/skills/tooling/git-workflows/skills/git-workflows

## Description
Use when working with git worktrees, GitHub CLI, branch management, or PR workflows. Covers gh CLI commands and git worktree patterns for parallel development.

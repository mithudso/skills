...
**Original Path:** gemini/mongodb-internal/.agents/skills/tooling/jira-ticket-creation/skills/jira-ticket-creation

## Description
Use when creating Jira tickets or bug reports. Covers Wiki Markup syntax, description templates, and field selection for any MongoDB Jira project.

---
name: variant-right-sizer
description: >-
  Use when optimizing Evergreen variant instance sizes for cost. Iteratively
  scales down instance sizes, tests via patches, and finds the smallest
  viable size for each distro used by a variant.
source: 10gen/agent-skills
license: Internal
mongodb:
  team: devprod-correctness
  owner: teo.voinea@mongodb.com
  internal: true
---

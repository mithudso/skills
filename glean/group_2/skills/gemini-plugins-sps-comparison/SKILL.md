...
name: sps-comparison
description: >-
  Use when fetching SPS Performance Analyzer comparison results, checking
  multipatch comparison status, listing user comparisons, or creating new
  multipatches. Triggers on Performance Analyzer URLs or comparison IDs.
source: 10gen/performance-ai
license: Internal
mongodb:
  team: release-quality
  owner: steph.wang@mongodb.com
  internal: true
---

---
name: mozjs-upgrade-integrate
description: >-
  Use when integrating upgraded MozJS/SpiderMonkey sources into the mongo repository.
  Covers updating import.sh, running extract.sh, generating platform-specific files with
  gen-config.sh, building, and bumping version metadata. Use when asked to "integrate mozjs",
  "generate platform files for mozjs", "run gen-config for mozjs", or "finish mozjs integration".
source: 10gen/mongo
license: Internal
mongodb:

...
keywords:
  ...
  - FTC AI disclosure
  - copy testing pipeline
  - brand voice drift
  - AI-generated content compliance
whenToUse: "Use when planning or executing an AI-assisted copy production workflow — from structuring brand-voice prompts through review checklists, scaling variation generation, and navigating FTC compliance. Most valuable when the user is operationalizing LLM use in a marketing team, not just writing one-off drafts."
whenNotToUse: "Skip when the user needs prose craft technique (AIDA, PAS, headline formulas) — that is direct-response-and-sales-letter-copywriting. Skip when the task is editing a finished draft for AI-voice tells — that is kill-the-ai-ism. Skip for general prompt-engineering mechanics — that is ai-mcp-sdk-prompting."
---
...
- **System prompt / custom GPT / Codex Project:** Up to ~2,000 words. Embed full brand-voice spec as reusable context.

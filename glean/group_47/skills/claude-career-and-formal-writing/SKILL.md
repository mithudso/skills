...
This hub covers **eight domains** across **14 on-demand reference files**: resumes/CVs, cover letters, job descriptions, performance reviews, academic/citation writing, legal-adjacent drafting, policy/governance writing, and survey question design. Six files extend the resume/CV domain: an ATS deep-dive, plus five career-positioning spokes — career-transition resumes, skills-based hiring & verified credentials, LinkedIn profile & personal branding, technical portfolio & GitHub curation, and AI-era resume screening & authenticity.
...
| `career-transition-into-tech-resumes` | Career-changer resumes — hybrid/functional layout, transferable-skills translation, bootcamp and no-CS-degree positioning, project-based resumes | `references/career-transition-into-tech-resumes.md` |
| `skills-based-hiring-and-verified-credentials` | Skills-based hiring — degree-optional posting language, verified assessments (LinkedIn/HackerRank/Codility), certification value, portfolio-vs-credential trust | `references/skills-based-hiring-and-verified-credentials.md` |
| `linkedin-profile-and-personal-branding` | LinkedIn profile content and positioning — headline, About, Featured, Experience mechanics, recruiter psychology, algorithm/All-Star gate (not automation — see `automated-job-applications` for Easy Apply/bots) | `references/linkedin-profile-and-personal-branding.md` |
| `technical-portfolio-and-github-curation` | Technical portfolio craft — pinned-repo strategy, README-as-sales-document, live-demo hosting, personal site, OSS vs solo-project signal | `references/technical-portfolio-and-github-curation.md` |
| `ai-era-resume-screening-and-authenticity` | AI-era screening dynamics — LLM/embedding evaluation layer beyond keyword ATS, AI resume-tailoring tool failure modes, AI-detection tells, normalized-vs-stigmatized debate | `references/ai-era-resume-screening-and-authenticity.md` |

...
**Platform:** Claude
**Original Path:** claude/standalone/writing-expert
...
- **Multi-pass structural/factual document critique** (review loop, fact-check, ship-readiness) → writing-expert (references/document-critique.md)

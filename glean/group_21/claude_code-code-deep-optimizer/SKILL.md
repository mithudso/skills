...
metadata:
  changelog: |
    2026-06-23 sko v1.5.0->1.6.0 — Pass H 10/10 pos, 0/15 neg (predicted); 2 Medium fixed: added advisory model/effort frontmatter (Step 4.6 -> Codex-opus-4-8 / xhigh, long-horizon agentic tier); trimmed changelog 8->5 entries (family 5-cap). No content/routing/over-ceiling/hygiene findings.

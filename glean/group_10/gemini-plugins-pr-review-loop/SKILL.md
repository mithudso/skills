---
name: pr-review-loop
description: Use when monitoring a PR for CI failures or reviewer feedback, responding to review comments, or babysitting a build.
argument-hint: "[interactive|autonomous]"
allowed-tools: [Read, Edit, Write, Glob, Grep, Bash, Agent, AskUserQuestion, mcp__Evergreen__get_my_patches, mcp__Evergreen__get_parsely_logs_for_patch, mcp__Evergreen__debug_failing_task, mcp__Evergreen__summarize_patch_tasks]
source: 10gen/agent-skills
license: Internal
mongodb:
  team: devprod-bv
  owner: ron.sanzone@mongodb.com
  internal: true

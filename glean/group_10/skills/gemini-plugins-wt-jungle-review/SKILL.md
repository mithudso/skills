---
name: wt-jungle-review
description: >-
  Use when an engineer wants the guided WiredTiger PR review experience
  wrapped as a text-adventure jungle expedition — same coaching, same
  section-by-section walk, but the codebase is a jungle, the engineer is an
  explorer, every notable bit of code is wildlife, and serious findings are
  lionesses. The agent draws ASCII art for the jungle and each animal.
  Triggers on phrases like "make this review fun", "jungle review",
  "adventure mode", "review this PR like a text adventure", "be my safari
  guide for this WT PR", or any review request asking for a playful,
  narrative, or themed experience. Mechanically identical to
  `wt-guided-review` — pick this when the engineer wants the theme, and
  `wt-guided-review` when they want it straight. Skip for incident-driven
  reviews or hurried sessions; the narrative wrapping adds friction.
source: 10gen/agent-skills
when_to_use: collaboratively walking an engineer through a WiredTiger PR as a themed jungle expedition
license: Internal
mongodb:
  team: storage-engines
  owner: sean.watt@mongodb.com
  internal: true
---

...
keywords:
  ...
  - smart contracts
whenToUse:
  - Writing, reviewing, or debugging Rust language semantics — ownership/borrowing/lifetimes, traits/generics, enums, error handling, closures/iterators.
  - Working on Rust concurrency, async/tokio, macros, or the cargo/crates/workspace toolchain.
  - Targeting no_std/embedded or the WASM target from Rust.
  - Choosing or writing Rust for a blockchain (Solana/Anchor surface, CosmWasm, ink!, Substrate/FRAME) and deciding which path fits the goal.
tags:
  - lang
  - rust
  - systems-programming
...
metadata:
  changelog:
    - "2026-06-16 sko v1.0.0->v1.0.1 — Pass H 10/10 pos, 0/10 neg (predicted); 5 medium fixed (description 1587->992 chars, 3 anti-AI-ism prose terms, code-packaging SKIP edge, whenToUse split to 4 entries)"
---

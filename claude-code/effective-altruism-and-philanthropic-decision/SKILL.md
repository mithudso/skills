---
name: effective-altruism-and-philanthropic-decision
title: Effective Altruism & Philanthropic Decision-Making
description: >-
  Guide evidence-based, normative decisions about where to give and how to maximize philanthropic
  impact. TRIGGER: effective altruism (EA), Singer's drowning-child/shallow-pond argument,
  MacAskill, Toby Ord; GiveWell charity evaluation, cost-per-outcome, cost per QALY/DALY;
  scale-neglectedness-tractability (SNT/ITN) framework; earning to give; longtermism critique;
  analytic vs emotional giving tension; measurability bias; EA critiques / post-FTX; moral
  circle expansion; philanthropic portfolio strategy; value pluralism in giving; "where should
  I donate to do the most good"; "is EA effective"; "how to evaluate a charity rigorously".
  SKIP: donor psychology / warm-glow / compassion fade → psychology-of-charitable-giving;
  moral foundations → moral-psychology; cognitive biases / decision heuristics →
  behavioral-decision-making; donor campaign / marketing → venture-cause-nonprofit-marketing;
...
keywords:
  ...
  - measurability bias
  - post-FTX EA critique
related_skills:
  - applied-psychology
  - psychology-of-charitable-giving
  - fundraising-and-donor-psychology
whenToUse:
  - "What is effective altruism and how does it work?"
  - "Which charities give the most bang for my buck?"
  - "Should I earn to give or work directly at a nonprofit?"
  - "How does GiveWell evaluate charities?"
  - "Is longtermism a good philanthropic strategy?"
  - "What is the scale-neglectedness-tractability framework?"
  - "I want to donate $X — where will it do the most good?"
  - "How do I evaluate a charity not on GiveWell's list?"
  - "What's the head-vs-heart tension in giving decisions?"
  - "Moral circle expansion and animal welfare giving"
whenNotToUse: >-
  Do not use when the question is about the psychology of WHY donors give (warm-glow,
  identifiable-victim effect, compassion fade) — use psychology-of-charitable-giving. Do not
  use for fundraising campaign design, donor cultivation, or nonprofit legal formation.
---

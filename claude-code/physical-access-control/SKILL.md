...
tags:
  ...
  - physical-security
whenToUse:
  - "choosing an RFID band or air-interface standard (LF/HF/UHF, EPC Gen2, ISO 14443/15693)"
  - "NFC and NDEF formats, tag types, HCE vs secure element, phone NFC APIs"
  - "MIFARE / DESFire card memory, keys, and on-card crypto"
  - "Wiegand vs OSDP reader-to-controller wiring and HID credential families"
  - "PACS architecture — controllers, door hardware, fail-safe/secure, egress codes, head-end"
  - "assessing or hardening a badge deployment against skim/clone/relay attacks"
  - "phone-as-credential, Apple/Google Wallet badges, Aliro, UWB secure ranging, mDL"
  - "physical-logical convergence, PIV/FIPS 201/FICAM, ONVIF, biometric-privacy law"
whenNotToUse:
  - "Web/app/cloud/infrastructure security review → security-review"
  - "Web Crypto API / vault implementation code → webcrypto-vault-reviewer"
  - "Blockchain protocol or crypto-primitive math → blockchain"
related_skills:
  - security-review
  - misc-catch-all
metadata:
  changelog:
    - "2026-06-21 created hub v1.0.0: folded 8 homeless physical-access-control spokes (rfid-fundamentals, nfc-ndef, contactless-smartcards, wiegand-osdp, pacs-architecture, rfid-nfc-attacks, mobile-credentials-aliro-uwb, physical-security-convergence) into one hub-and-spoke family via skill-tree-architect"
---

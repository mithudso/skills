...
name: cost-reducer
description: >-
  Use when auditing Claude Code or agent setup for cost reduction opportunities.
  Analyzes SKILL.md and CLAUDE.md files for bloat, identifies hook automation
  opportunities, flags expensive model choices, and surfaces parallelization gaps.
disable-model-invocation: true
source: 10gen/agent-skills
license: Internal
mongodb:
  team: devprod-correctness

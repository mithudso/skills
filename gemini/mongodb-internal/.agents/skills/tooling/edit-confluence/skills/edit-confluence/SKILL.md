---
name: edit-confluence
description: >-
  Use when editing Confluence wiki pages via MCP tools. Covers safe editing
  workflow: fetch first, edit in storage format, handle CDATA blocks.
source: 10gen/mongo
license: Internal
mongodb:
  team: devprod-bv

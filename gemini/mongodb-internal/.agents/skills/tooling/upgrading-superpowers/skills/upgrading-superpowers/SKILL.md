---
name: upgrading-superpowers
description: >-
  Use when upgrading, syncing, or diffing the vendored obra/superpowers skills in
  10gen/agent-skills against a new upstream superpowers release.

...
2. **Hub / router** — it routes specific questions down to the family's spokes (see the routing table for the original 17-spoke plan, and the Foundation references table below for all 40 reference files as built). The spokes are the *intended* family; as each is built it owns its depth and this hub just points to it.

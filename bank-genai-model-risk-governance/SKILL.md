---
name: bank-genai-model-risk-governance
description: >-
  GenAI/LLM governance and model-risk framing for BANKS (FSI), for a MongoDB TAM
  advising banks on AI/LLM/vector-search. Educational, NOT legal/compliance
  advice. TRIGGER: model risk management for AI/LLM (SR 11-7 and its 2026
  successor SR 26-2; effective challenge; model inventory); how MRM applies to
  non-deterministic GenAI & third-party/vendor models; NIST AI RMF 1.0
  (GOVERN/MAP/MEASURE/MANAGE) and the Generative AI Profile (NIST-AI-600-1); EU
  AI Act (Reg 2024/1689) risk tiers, GPAI obligations, applicability timeline,
  credit-scoring as high-risk; validating a RAG/vector-search system. SKIP:
  company-specific account intel -> goldman-sachs-account-intelligence /
  jpmorgan-chase-account-intelligence; general FSI regulation ->
  fsi-banking-regulatory-context; vendor/third-party-risk ->
  enterprise-vendor-management-and-tprm; prompt-injection ->
  rag-prompt-injection-defense; security controls ->
  atlas-vector-search-pii-isolation / mongodb-operations-expert.
version: 1.1.0
updated: 2026-06-29
category: custom
...
effort: high
whenToUse:
  - How does bank model-risk management (SR 11-7 / SR 26-2) apply to an LLM or RAG system?
  - What is "effective challenge," a model inventory, and independent validation for AI models?
  - How do banks validate a non-deterministic GenAI / vector-search system for governance?
  - What is the NIST AI RMF and its Generative AI Profile, and how do I map a design to it?
  - What does the EU AI Act require of a bank deploying an LLM system, and on what timeline?
  - A bank asks what governance artifacts they need before putting an Atlas Vector Search RAG assistant into production.
keywords:
  - bank model risk management GenAI LLM
  - SR 11-7 SR 26-2 supervisory guidance model risk
  - effective challenge model inventory independent validation
  - non-deterministic GenAI validation third-party vendor models
  - NIST AI RMF 1.0 GOVERN MAP MEASURE MANAGE
  - NIST AI 600-1 Generative AI Profile confabulation
  - EU AI Act 2024/1689 risk tiers GPAI systemic risk
  - high-risk AI credit scoring Annex III
  - AI governance artifacts validation RAG vector search
  - model documentation ongoing monitoring
tags:
  - ai-governance
  - model-risk
  - fsi
